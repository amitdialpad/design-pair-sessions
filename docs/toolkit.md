...
Add `skip review` to skip the AI review step (good for docs, skill updates, small changes). Add `new gif` if you want a different GIF.

**Use when:** `/pr-prep` is clean and you're ready to share.
