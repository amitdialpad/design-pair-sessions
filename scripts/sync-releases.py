#!/usr/bin/env python3
"""
Fetch beacon-app GitHub releases via API and update the
<!-- BEACON_RELEASES_START/END --> block in docs/whats-new.md.

Requires GH_TOKEN env var with read access to dialpad/beacon-app.
Store a personal PAT as BEACON_PAT in repo secrets.
